  ...
  return (
    <main className="Works">
      <p className="intro-text">
        ...
        designer. I'm <br />passionate about crafting unique designs that elevate
        brand identities and bring ideas to life.✨
      </p>
      <section className="projects-section">
        <h1 className="heading-1"><span>Working hard is just part of who I am</span><small>💪</small></h1>
        ...
        <div className="project-card-2">
          ...
          <div className="img-div-2">
            <img className="image-2" alt="movie mania" src="mr lens.png"></img>
